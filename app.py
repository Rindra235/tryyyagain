...
st.info("Silakan pilih menu di sidebar untuk melihat, mencari, atau mengedit Database.")
...
conn = st.connection("postgresql", type="sql", 
                     url="postgresql://arindra.megantaraa:Ggul80wZEnox@ep-nameless-field-19754091.us-east-2.aws.neon.tech/Web")
